...
TARGET_NAME := $DIRNAME$
TARGET		= $(if $(OUT_DIR),$(OUT_DIR)/,)$(TARGET_NAME).dll
...
ifeq "$(CFG)"  "release"
CFLAGS+=-W -fexceptions -O2 -DNDEBUG -DWIN32 -D_WINDOWS -D_MBCS -D_USRDLL -DFREEGLUT_EXPORTS
LD=dllwrap
LDFLAGS=
LDFLAGS+=
...
ifeq "$(CFG)"  "debug"
CFLAGS+=-W -fexceptions -g -O0 -D_DEBUG -DWIN32 -D_WINDOWS -D_MBCS -D_USRDLL -DFREEGLUT_EXPORTS
LD=dllwrap
LDFLAGS=
LDFLAGS+=
LIBS+=-lkernel32 -luser32 -lgdi32 -lwinspool -lcomdlg32 -ladvapi32 -lshell32 -lole32 -loleaut32 -luuid -lodbc32 -lodbccp32
